...
func TestBIFAccessors(t *testing.T) {
	...
	cases := []struct {
	...
	}{
		{
			...
			wantTypes:   map[opentile.AssociatedType]bool{opentile.AssociatedOverview: true, opentile.AssociatedLabel: true, opentile.AssociatedProbability: true},
			wantScanRes: 0.25,
			hasICC:      true,
		},
		{
			...
			wantTypes:   map[opentile.AssociatedType]bool{opentile.AssociatedOverview: true, opentile.AssociatedLabel: true, opentile.AssociatedThumbnail: true},
			wantScanRes: 0.2325,
			hasICC:      false,
		},
	}
